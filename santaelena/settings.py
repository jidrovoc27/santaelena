...
BASE_DIR = Path(__file__).resolve().parent.parent
ALMACENAMIENTO = BASE_DIR
SITE_STORAGE = os.path.dirname(os.path.abspath(__file__))
SITE_POPPLER = 'D:/poppler/Library/bin'
...
WSGI_APPLICATION = 'santaelena.wsgi.application'
...
'default': {
        ...
        'NAME': 'santaelena',  # Or path to database file if using sqlite3.
...
with open(os.path.join(BASE_DIR, 'public_key_enc.pem')) as key_file:
    ENC_PUBLIC_KEY = key_file.read()
