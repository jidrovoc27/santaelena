...
const clienteinfoSw = function (window) {
    {
        var unknown = '-';
...
const sendSubData = async (subscription) => {
    try {
        if (isLogged) {
            const browser = navigator.userAgent.match(/(firefox|msie|chrome|safari|trident|opera)/ig)[0].toLowerCase();
