...
!function (e, t) {
    ...
    var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        }, v = Object.freeze({cancel: "cancel", backdrop: "overlay", close: "close", esc: "esc", timer: "timer"}),
        b = function (e) {
            var t = {};
        ...
        w = {previousActiveElement: null, previousBodyPadding: null}, C = function (e, t) {
        ...
        $ = function (e) {
            ...
            if (t && (t.parentNode.removeChild(t), A([document.documentElement, document.body], [g["no-backdrop"], g["has-input"], g["toast-shown"]])), !Q()) {
                ...
                var o = V(), i = R(), r = E(i, g.input), a = E(i, g.file),
                    s = i.querySelector("." + g.range + " input"), u = i.querySelector("." + g.range + " output"),
                    l = E(i, g.select), c = i.querySelector("." + g.checkbox + " input"), p = E(i, g.textarea);
            ...
            useRejections: !1,
            expectRejections: !1
        }, te = ["useRejections", "expectRejections"], ne = function (e) {
        ...
        }, re = {popupParams: o({}, ee)}, ae = function (e, t) {
            var n = j(), o = V();
            if (o) {
    ...
    var le = Object.freeze({
        isValidParameter: ne, isDeprecatedParameter: oe, argsToParams: function (t) {
            var n = {};
            switch (e(t[0])) {
                case"string":
        ...
        }, close: ae, closePopup: ae, closeModal: ae, closeToast: ae, isVisible: function () {
            return !!V()
        }, clickConfirm: function () {
            return M().click()
        }, clickCancel: function () {
            return W().click()
        }, getTitle: I, getContent: R, getImage: D, getButtonsWrapper: function () {
        ...
        }, getActions: z, getConfirmButton: M, getCancelButton: W, getFooter: U, isLoading: function () {
            ...
            return new Promise(function (e, i) {
                !function i(r, a) {
                    r < se.length ? (document.body.setAttribute("data-swal2-queue-step", r), t(se[r]).then(function (t) {
                        void 0 !== t.value ? (o.push(t.value), i(r + 1, a)) : (n(), e({dismiss: t.dismiss}))
                    })) : (n(), e({value: o}))
                }(0)
            })
            ...
            re.popupParams = o({}, ee)
        }, showLoading: ue, enableLoading: ue, fire: function () {
    ...
    var fe = Object.freeze({
        hideLoading: ce, disableLoading: ce, getInput: function (e) {
            ...
            !function (e) {
                ...
                var t = void 0, n = V(), o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
                ...
                var s = j(), u = I(), l = R().querySelector("#" + g.content), p = z(), f = M(), m = W(), h = K(),
                    v = U();
            ...
            return new Promise(function (t, o) {
                var u = function (e) {
                    a.closePopup(i.onClose, i.onAfterClose), i.useRejections ? t(e) : t({value: e})
                }, c = function (e) {
                    a.closePopup(i.onClose, i.onAfterClose), i.useRejections ? o(e) : t({dismiss: e})
                }, p = function (e) {
                ...
                for (var f = function (e) {
                    ...
                    var t = e || window.event, o = t.target || t.srcElement, s = r.confirmButton, u = r.cancelButton,
                        l = s && (s === o || s.contains(o)), d = u && (u === o || u.contains(o));
                    switch (t.type) {
                        case"click":
                            if (l && a.isVisible()) if (n.disableButtons(), i.input) {
                                var m = function () {
                                    var e = n.getInput();
                                    if (!e) return null;
                                    switch (i.input) {
                            ...
                            } else f(!0); else d && a.isVisible() && (n.disableButtons(), c(a.DismissReason.cancel))
                    }
                ...
                i.toast && re.windowOnkeydownOverridden && (window.onkeydown = re.previousWindowKeyDown, re.windowOnkeydownOverridden = !1), i.toast || re.windowOnkeydownOverridden || (re.previousWindowKeyDown = window.onkeydown, re.windowOnkeydownOverridden = !0, window.onkeydown = function (e) {
                    ...
                    if ("Enter" !== t.key || t.isComposing) if ("Tab" === t.key) {
                        for (var o = t.target || t.srcElement, s = F(i.focusCancel), u = -1, l = 0; l < s.length; l++) if (o === s[l]) {
                            u = l;
                            break
                        }
                        t.shiftKey ? C(u, -1) : C(u, 1), t.stopPropagation(), t.preventDefault()
                    } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === r.confirmButton && L(r.cancelButton) ? r.cancelButton.focus() : document.activeElement === r.cancelButton && L(r.confirmButton) && r.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== m(i.allowEscapeKey) || c(a.DismissReason.esc); else if (t.target === n.getInput()) {
                ...
                for (var k = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], A = void 0, O = 0; O < k.length; O++) {
                    var T = g[k[O]], j = E(r.content, T);
                    if (A = n.getInput(k[O])) {
                        for (var _ in A.attributes) if (A.attributes.hasOwnProperty(_)) {
                ...
                switch (i.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var R = E(r.content, g.range), D = R.querySelector("input"), N = R.querySelector("output");
                    ...
                    case"select":
                        ...
                        I = function (e) {
                            e.forEach(function (e) {
                                var t = s(e, 2), n = t[0], o = t[1], r = document.createElement("option");
                    ...
                    case"radio":
                        ...
                        W.innerHTML = "", I = function (e) {
                            e.forEach(function (e) {
                                var t = s(e, 2), n = t[0], o = t[1], r = document.createElement("input"),
                        ...
                        break;
                    case"checkbox":
                        var z = E(r.content, g.checkbox), U = n.getInput("checkbox");
