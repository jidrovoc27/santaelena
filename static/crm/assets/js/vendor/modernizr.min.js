!function (i, f, d) {
    ...
    function s(e) {
        var t, n = C.className, o = g._config.classPrefix || "";
    ...
    function l(e, t) {
        if ("object" == typeof e) for (var n in e) S(e, n) && l(n, e[n]); else {
            var o = (e = e.toLowerCase()).split("."), r = g[o[0]];
    ...
    function r(e, t, n, o) {
        var r, i, s, a = "modernizr", l = p("div"), u = ((s = f.body) || ((s = p(b ? "svg" : "body")).fake = !0), s);
        if (parseInt(n, 10)) for (; n--;) (r = p("div")).id = o ? o[n] : a + (n + 1), l.appendChild(r);
    ...
    function h(e, t, n) {
        var o, r;
        for (r in e) if (e[r] in t) return !1 === n ? e[r] : (o = t[e[r]], a(o, "function") ? function (e, t) {
            return function () {
    ...
    var g = new g, y = [], C = f.documentElement, b = "svg" === C.nodeName.toLowerCase(), t = "Moz O ms Webkit",
    ...
    g.addTest("websockets", t), g.addTest("cssanimations", A("animationName", "a", !0)), function () {
        g.addTest("csscolumns", function () {
            var e = !1, t = A("columnCount");
            try {
                e = (e = !!t) && new Boolean(e)
            } catch (e) {
            }
    ...
    }), g.addTest("srcset", "srcset" in p("img")), g.addTest("webworkers", "Worker" in i), function () {
        var e, t, n, o, r, i, s;
        for (s in v) if (v.hasOwnProperty(s)) {
            if (e = [], (t = v[s]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
