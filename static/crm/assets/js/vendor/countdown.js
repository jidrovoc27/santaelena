!function (c) {
    ...
    c.fn.showclock = function () {
        ...
        0 != t && (n += "<div class='countdown-container days'>", n += "<span class='countdown-value days-bottom'>" + e(t) + "</span>", n += "<span class='countdown-heading days-top'>Días</span>", n += "</div>"), n += "<div class='countdown-container hours'>", n += "<span class='countdown-value hours-bottom'>" + e(o) + "</span>", n += "<span class='countdown-heading hours-top'>Horas</span>", n += "</div>", n += "<div class='countdown-container minutes'>", n += "<span class='countdown-value minutes-bottom'>" + e(s) + "</span>", n += "<span class='countdown-heading minutes-top'>Mins</span>", n += "</div>", n += "<div class='countdown-container seconds'>", n += "<span class='countdown-value seconds-bottom'>" + e(a) + "</span>", n += "<span class='countdown-heading seconds-top'>Seg</span>", this.html(n += "</div>")
